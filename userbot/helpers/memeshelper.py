...
INSULT_STRINGS = [
     ...
     "Infelizmente! Seus neurotransmissores não estão mais funcionando.",
     "Você está louco, seu tolo.",
     "Como um estranho, o que você acha da raça humana?",
     "Acredite, você não é normal.",
     "A regra de bot 420, seção 69, me impede de responder a idiotas estúpidos como você.",
     "Regra de bot 544 seção 9 me impede de responder a humanos estúpidos como você.",
     "Cérebros não são tudo. No seu caso não são nada.",
     "Volte e fale comigo quando seu QI exceder sua idade.",
     "Comando não encontrado. Assim como seu cérebro.",
     "Dance nua em alguns fios HT.",
     "Não beba e digite.",
     ...
     "Vá verde! Pare de inalar oxigênio.",
     "Deus estava procurando por você. Você deveria sair para encontrá-lo.",
     "Você já tentou atirar em si mesmo até 100m usando um canhão.",
     "Tiros na cabeça são divertidos. Arranja um.",
     "Acerte o Urânio com um nêutron em movimento lento em sua presença. Será uma experiência que vale a pena.",
     "Que tal você parar de respirar por 1 dia? Isso vai ser ótimo.",
     "Não estou dizendo que você é estúpido, só estou dizendo que você tem azar quando se trata de pensar.",
     "Me desculpe por ter ferido seus sentimentos quando te chamei de estúpido. Achei que você já soubesse disso.",
     "Aposto que seu cérebro está como novo, já que você nunca o usa.",
     "Eu não sei o que te faz tão estúpido, mas realmente funciona.",
     "Se eu quisesse me matar, escalaria seu ego e pularia para o seu QI.",
     "Se você está falando pelas minhas costas, então você está na posição perfeita para beijar minha bunda!",
     "Ouvi dizer que o phogine é venenoso, mas acho que você não se importaria de inalá-lo por diversão.",
     "Acho que você deveria ir para casa ou melhor para um manicômio.",
     "Eu perguntaria quantos anos você tem, mas eu sei que você não pode contar tão alto.",
     "Continue falando, um dia você dirá algo inteligente!......(mas duvido)",
     "Lançar-se no espaço sideral enquanto esquece o oxigênio na Terra.",
     "Normalmente as pessoas vivem e aprendem. Você apenas vive.",
     "Owww... Que idiota estúpido.",
     "Pessoas como você são a razão de termos dedos do meio.",
     "Pegue uma arma e atire em si mesmo.",
     "Choque-me, diga algo inteligente.",
     "Desculpe, não vendemos cérebros.",
     "Pare de falar besteira e pule na frente de um trem bala em movimento.",
     ...
     "Tente jogar pega-pega com RDX é divertido.",
     "Tente provocar um tigre enquanto vocês dois estão em uma jaula.",
     "Tente o seguinte: se você prender a respiração debaixo d'água por uma hora, poderá segurá-la para sempre.",
     "Tente passar um dia em um caixão e ele será seu para sempre.",
     "Voluntário para alvo em um campo de tiro.",
     "Que idioma você está falando? Porque parece besteira.",
     "Quando sua mãe te deixou na escola, ela ganhou uma multa por jogar lixo.",
     "Você é a prova de que a evolução PODE andar ao contrário.",
     "Você pode ser a primeira pessoa a pisar no sol. Tente.",
     "Você pode ficar debaixo d'água pelo resto de sua vida sem voltar para cima.",
     ...
     "Você deve se voluntariar para o alvo em um campo de tiro.",
     "Você deveria doar seu cérebro já que nunca o usou.",
     "Você deveria se pintar de vermelho e correr em uma maratona de touros.",
     "Você deve tentar segurar o TNT na boca e acendê-lo.",
     "Você deveria tentar um banho quente em um vulcão.",
     "Você deveria tentar brincar de cobra e escadas, com cobras reais e sem escadas.",
     "Você deveria tentar dormir para sempre.",
     "Você deveria tentar nadar com grandes tubarões brancos.",
     "Você deveria tentar provar cianeto.",
     "Você é tão feio que quando você chora, as lágrimas rolam pela sua cabeça... só para evitar o seu rosto.",
     "Os zombies comem cérebros tu estás safo.",
